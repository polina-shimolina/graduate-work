...
const Main = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <div style={{ maxWidth: '1000px', width: '100%' }}>
        ...
        <div>
          ...
          <h3>Технология</h3>
            <p>В основе технологии лежит архитектура U-Net MobilenetV2. Архитектура сети представляет собой полносвязную свёрточную сеть, модифицированную так, чтобы она могла работать с меньшим количеством примеров (обучающих образов) и делала более точную сегментацию.</p>
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <Link to="https://github.com/polina-shimolina/graduate-work">GitHub репозиторий проекта</Link>
    </div>
